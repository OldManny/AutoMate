...
class FileOrganizerCustomizationDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.folder_icon_btn.clicked.connect(
            self.select_folder
        )  # Connect icon button to folder selection
        ...
        self.sort_by_type.stateChanged.connect(
            lambda: self.single_selection(self.sort_by_type)
        )
        ...
        self.sort_by_date.stateChanged.connect(
            lambda: self.single_selection(self.sort_by_date)
        )
        ...
        self.sort_by_size.stateChanged.connect(
            lambda: self.single_selection(self.sort_by_size)
        )
        ...
        self.detect_duplicates.stateChanged.connect(
            lambda: self.single_selection(self.detect_duplicates)
        )
        ...
        self.rename_files.stateChanged.connect(
            lambda: self.single_selection(self.rename_files)
        )
        ...
        self.compress_files.stateChanged.connect(
            lambda: self.single_selection(self.compress_files)
        )
        ...
        self.backup_files.stateChanged.connect(
            lambda: self.single_selection(self.backup_files)
        )
